...
import PrintDiscount from "@/app/(views)/approver/_components/prints/PrintDiscount";
                    ...
                    : editableRecord.form_data[0].items.map(
                        (item: any, index: any) => (
                          <tr key={index}>
                            ...
                            <td className={tableCellStyle}>{Number(item.labor).toFixed(2)}</td>
                            <td className={tableCellStyle}>{Number(item.spotcash).toFixed(2)}</td>
